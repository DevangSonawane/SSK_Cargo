...
import '../../data/gps_demo_fleet.dart';
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...gpsDemoFleetVehicles.asMap().entries.expand(
                    (entry) => [
                      _VehicleCard(vehicle: entry.value, compact: isCompact),
                      if (entry.key != gpsDemoFleetVehicles.length - 1)
...
class _VehicleCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: InkWell(
        onTap: () => context.go('/gps/maps/${vehicle.id}'),
        borderRadius: BorderRadius.circular(18),
        child: Container(
